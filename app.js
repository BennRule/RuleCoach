...
const EXERCISE_INFO = {
  ...
  'Rear Fly Machine': { video: 'yYwpr72z6vk', desc: 'Rear Fly Machine begins seated facing the machine with arms extended forward, gripping the handles at chest height. Open the arms out to the sides by squeezing the rear deltoids and upper back. Return the handles under control to the starting position.' },
